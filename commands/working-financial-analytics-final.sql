-- Working Financial Analytics - Final Version
-- Based on confirmed column access and avoiding problematic CTE structures

-- Method 1: Direct Subqueries (guaranteed to work)
SELECT 
...
-- Method 2: Category Breakdown (separate query to avoid CTE issues)
SELECT 
...
-- Method 3: Animal Breakdown (separate query)
SELECT 
...
-- Total Expenses: $45.99 (confirmed from your CSV)
-- Total Income: $1,200.00 (from your test data)
-- Predicted Income: Sum of your animals' predicted_sale_cost values
-- Net Profit: Should be very positive ($1,200+ - $45.99)
